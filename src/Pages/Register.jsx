...
const Register = () => {
    ...
    return (
        <div className="hero px-2 mt-8">
            ...
            <div className="card bg-secondary w-full max-w-sm shrink-0 shadow-2xl py-5" >
                ...
                <div className="card-body py-0">
                    <form onSubmit={handleRegister} className="fieldset">
                        ...
                        <input type="text" className="bg-white text-primary z-50 border-primary input" placeholder="Your Name" name='name' required />

                        <label className="text-white font-medium text-lg label">Photo</label>
                        <input type="text" className="bg-white text-primary z-50 border-primary input" placeholder="Photo-URL" name='photo' required />

                        <label className="text-white font-medium text-lg label">Email</label>
                        <input type="email" className="bg-white text-primary z-50 border-primary input" placeholder="Your Email" name='email' required />
                        ...
                        <input
                            ...
                            name='password'
                            required
                            className="bg-white text-primary z-50 border-primary input validator "
                        ...
                        <button type='submit' className='btn mt-2 text-lg hover:bg-green-800 bg-green-900 text-white border-[#e5e5e5] z-50' >Register</button>
                    ...
                    <button type='submit' onClick={handleGoogleBtn} className="btn hover:bg-green-800 bg-green-900 border-[#e5e5e5] text-white z-50">
            ...
            <img className='fixed md:block hidden  z-10 h-[700px] top-0 -right-8' src="https://i.postimg.cc/Hs52Tb22/leaves-png-4-by-agusrockforlife-ddwjkcw.png" alt="" />
