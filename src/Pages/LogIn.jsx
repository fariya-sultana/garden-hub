                ...
                <div className="card-body py-0">
                    <form onSubmit={handleLogin} className="fieldset space-y-1">
                        ...
                        <input
                            ...
                            name='password'
                            required
                            className="bg-white text-primary z-50 border-primary input"
                            placeholder="Your Password"
                        />

                        <div><a className="link link-hover text-sm text-white z-50">Forgot password?</a></div>

                        <button type='submit' className='btn mt-2 hover:bg-green-800 text-lg bg-green-900 z-50 text-white border-[#e5e5e5]' >Login</button>
                    ...
                    <button type='submit' onClick={handleGoogleBtn} className="btn hover:bg-green-800 bg-green-900 z-50 border-[#e5e5e5] text-white">
